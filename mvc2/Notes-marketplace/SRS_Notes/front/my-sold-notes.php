                    ...
                    <div class="col-md-12 col-lg-12 col-12 col-sm-12">
                        <div class="sold-note-table table-responsive">
                            ...
                            <table class="table table-hover" id="mysoldnotes-table">
                                ...
                                <tbody>
                                    <?php
                                    $mysoldnotes = "SELECT * FROM downloads WHERE IsSellerHasAllowedDownload = 1 AND Seller = $user_id AND Downloader != $user_id GROUP BY NoteID,Downloader ORDER BY AttachmentDownloadedDate DESC";
                                    ...
                                    ?>
                                        ...
                                        <tr style="height: 50px;">
                                            ...
                                            <td class="text-center"><a href="#"><img src="images/Dashboard/eye.png" alt="eye"></a>
